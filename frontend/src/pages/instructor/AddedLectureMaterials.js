...
const AddedLectureMaterials = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://veritas-campus-lms-production.up.railway.app/api/instructor/lecturematerial/${courseId}`
      )
  ...
  return (
    <div className="container mt-4">
      <h3 style={{ color: "#55B649" }}>
        Added Lecture Materials {course.code && `- ${course.code}`}{" "}
      ...
      <div className="row mb-3">
        ...
        <div className="col-md-6 text-end">
          <Link
            to={`https://veritas-campus-lms-production.up.railway.app/api/instructor/lecturematerial/${courseId}`}
