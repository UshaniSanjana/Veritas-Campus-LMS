    ...
    <>
      {isSubmitting && (
        ...
        >
          ...
          />
          <div className="mt-3 text-primary fw-medium">
      ...
      <div className="container my-5">
        <div
          className="mx-auto p-4 bg-white rounded shadow"
          style={{ maxWidth: "900px" }}
        >
          <h2 style={{ color: "#55B649" }}>Submit Support Request</h2>
          <p style={{ fontSize: "0.9rem" }}>
            Fields marked with <span className="text-danger fw-bold">*</span>{" "}
            are required
          </p>
          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data">
              ...
              <div className="col-md-6 mb-3">
                <div className="form-floating">
                  ...
                  <label htmlFor="lectureID">
                    Lecture ID <span className="text-danger fw-bold">*</span>
                  </label>
                </div>
              </div>
              ...
              <div className="col-md-6 mb-3">
                <div className="form-floating">
                  <input
                    ...
                    required
                  />
                  <label htmlFor="lectureName">
                    Lecture Name <span className="text-danger fw-bold">*</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div
                {...getRootProps()}
                className={`border border-2 border-secondary rounded p-3 text-center bg-light ${
                  isSubmitting ? "opacity-50" : "hover border-primary bg-white"
                }`}
