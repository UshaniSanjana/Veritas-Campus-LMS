...
export default function ReportsPage() {
  ...
  useEffect(() => {
    axios
      .get(
        "https://veritas-campus-lms-production.up.railway.app/api/adminReport/logins"
      )
  ...
  const filteredRevisionData = revisionData.filter(
    (rev) =>
      ...
      <div className="reports-page" id="download-section">
        ...
        <div className="filter-bar">
          ...
          <button className="dbtn" onClick={downloadPageAsPDF}>
            <MdDownload size={17} style={{ verticalAlign: "middle" }} />{" "}
            Download Report
          </button>
        </div>
