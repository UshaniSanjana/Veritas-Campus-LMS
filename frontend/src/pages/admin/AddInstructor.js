...
function InstructorForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://veritas-campus-lms-production.up.railway.app/api/instructors",
        submitData,
        {
          headers: {
  ...
  const styles = {
    ...
    select: {
      ...
      appearance: "none",
      backgroundImage:
        "url(\"data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23718096' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3e%3cpolyline points='6 9 12 15 18 9'%3e%3c/polyline%3e%3c/svg%3e\")",
          ...
          <div style={styles.formGrid}>
            ...
            <div style={styles.formGroup}>
              ...
              {errors.contactNumber && (
                <p style={styles.fieldError}>{errors.contactNumber}</p>
              )}
            </div>
            ...
            <div style={styles.formGroup}>
              ...
              >
                ...
                <option value="Internal Sales & Marketing">
            ...
            <div style={styles.formGroup}>
              ...
              {errors.assignedCourse && (
                <p style={styles.fieldError}>{errors.assignedCourse}</p>
              )}
            </div>
