...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        const res = await axios.get(
          "https://veritas-campus-lms-production.up.railway.app/api/adminDashboard/dash"
        );
    ...
    const fetchCourseProgress = async () => {
      try {
        const res = await axios.get(
          "https://veritas-campus-lms-production.up.railway.app/api/adminDashboard/progress"
        );
    ...
    const fetchRevisionData = async () => {
      try {
        const [
          ...
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/courseRevisions"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/assignment"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/assignmentSubmission"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/changes"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/entroll"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/instructor"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/student"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/exam"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/instrucorSup"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/lectureM"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/quize"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/studentSup"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/lecture"
          ),
          axios.get(
            "https://veritas-campus-lms-production.up.railway.app/api/adminReport/quizeSubmition"
          ),
        ]);
        ...
        const assignmentSubmissionData = assignmentSubmissionRes.data.map(
          (submission) => ({
        ...
        <div className="dashboard-top">
          <div className="quick-overview">
            <div className="overview-box">
              Total Courses: {overview.totalCourses || 0}
            </div>
            <div className="overview-box">
              Total Instructors: {overview.totalInstructors || 0}
            </div>
            <div className="overview-box">
              Total Students: {overview.totalStudents || 0}
            </div>
            <div className="overview-box">
              Total Exams: {overview.totalExams || 0}
            </div>
            <div className="overview-box">
              Total Quizzes: {overview.totalQuizzes || 0}
            </div>
            <div className="overview-box">
              Total Certificates: {overview.totalCertificates || 0}
            </div>
          </div>
            ...
            {popularCourses.length === 0 ? (
              ...
              <ul>
                {popularCourses.map((course, index) => (
                  <li key={index}>
                    <div>
                      <strong>{course.users} Users</strong>
                    </div>
                    <div>
