...
const Instructor = () => {
  ...
  const fetchInstructors = async () => {
    ...
    try {
      ...
      setError(
        "Failed to fetch instructors. Please check your connection and try again."
      );
      setInstructors([]);
    } finally {
      setLoading(false);
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      setInstructors(
        instructors.filter((inst) => inst._id !== deletingInstructor._id)
      );
        ...
        <div className="modal-overlay">
          <div className="modal-content delete-modal">
            ...
            <p>
              ...
              <strong>{deletingInstructor.name}</strong>?
            </p>
            <div className="instructor-info">
              <p>
                <strong>Email:</strong> {deletingInstructor.email}
              </p>
              <p>
                <strong>Department:</strong> {deletingInstructor.department}
              </p>
            </div>
